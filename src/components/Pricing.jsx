...
const Pricing = () => {
 ...
 <>
    <div class="min-h-screen items-center">
            <div class="">
                <div class="text-start font-semibold mx-48">
                    <h1 class="text-5xl">
                ...
                <div class="my-16 sm:flex flex-wrap justify-center items-center gap-8 p-12">
                    ...
                    <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 py-4 bg-[#222331] mt-6 shadow-lg rounded-lg">
                    ...
                    <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 py-4 bg-[#222331] text-white mt-6 shadow-lg rounded-lg">
                        <div class="px-6 py-8 sm:p-10 sm:pb-6">
                            <div class="flex justify-center">
                                <span class="inline-flex px-4 py-1 rounded-full text-sm leading-5 font-semibold tracking-wide uppercase">
                                    Popular
