...
const Notes = ({ notes, id, name, gender, age, transcript }) => {
  console.log(notes);
  ...
  const [soapLike, setSoapLike] = useState(false);
  const [soapDislike, setSoapDislike] = useState(false);
  const isLiked = soapLike ? "violet" : "white" 
  const isDisliked = soapDislike ? "violet" : "white"
  ...
  const handleLike = async () => {
    try {
      const requestBody = {
        ...
        soapLike: true, // Update soapLike based on review_value
        patient_id: id,
      };
  ...
  const handleDislike = async () => {
    try {
      const requestBody = {
        ...
        soapDislike: true, // Update soapLike based on review_value
        patient_id: id,
      };
      console.log("Request body>>>>",requestBody);
