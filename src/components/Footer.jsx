...
const Footer = () => {
    return (
        <div>
                        ...
                        <div className="flex flex-col justify-start items-start gap-12 md:ml-16 -ml-4">
                            ...
                            <div className="flex justify-start space-x-6 bg-[#F3F5F7] rounded-lg px-8 py-2 ">
                                <div className="border-r-2 border-black ">
                                    <a rel="noopener noreferrer" href="#" title="Facebook" className="flex items-center p-1 mr-6">
                                ...
                                <div className="border-r-2 border-black  ">
                                    <a rel="noopener noreferrer" href="#" title="Twitter" className="flex items-center p-1 mr-6">
                    ...
                    <div className="grid grid-cols-1 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-3">
                        <div className="space-y-3">
                            ...
                            <ul className="space-y-6">
                                <li>
                                    <a rel="tracki noopener noreferrer font-[Raleway] text-xs " href="#">Overview</a>
                                </li>
                                <li>
                                    <a rel="tracki noopener noreferrer font-[Raleway] text-xs" href="#">Customer Stories</a>
                                </li>
                                <li>
                                    <a rel="tracki noopener noreferrer font-[Raleway] text-xs" href="#">Safety Standards</a>
                                </li>

                            </ul>
                        </div>
                        <div className="space-y-3">
                            <h3 className="tracki font-[Raleway] font-bold dark:text-gray-50">Research</h3>
                            <ul className="space-y-6">
                                <li>
                                    <a rel="noopener noreferrer text-xs" href="#">Overview</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer text-xs" href="#">Index</a>
                                </li>
                            </ul>
                        </div>
                        <div className="space-y-3">
                            <h3 className="font-[Raleway] font-bold dark:text-gray-50">Company</h3>
                            <ul className="space-y-6">
                                <li>
                                    <a rel="noopener noreferrer text-xs" href="#">About</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer text-xs" href="#">Blog</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer text-xs" href="#">Career</a>
                                </li>
                            </ul>
                        </div>
            ...
            <div className="w-full h-10 bg-[#0C0D0F]"></div>
        </div>
    )
}
